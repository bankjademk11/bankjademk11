    ...
    <div className="p-6 bg-surface rounded-2xl border border-gray-200">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {dailyMenu.vote_options.map((pack, index) => (
                  <div key={index} className="bg-surface rounded-lg p-4 border border-gray-200 flex items-center justify-between">
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-surface p-8 rounded-lg max-w-sm w-full">
