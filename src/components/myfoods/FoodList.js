      ...
      {filteredFoodItems.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredFoodItems.map((food) => (
            <div key={food.id} className="bg-gray-100 bg-opacity-90 rounded-2xl shadow-xl overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 ease-in-out flex flex-col cursor-pointer" onClick={() => handleCardClick(food)}>
